...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <section className="card-grid-cards-effect-appear">
      <div className="icon-container-grid-cards-effect-appear flex flex-col gap-4 items-center justify-center">
        {image_field ? (
          <img src={image_field.src} className="w-[80px] h-[80px]"></img>
        ) : (
          <svg
            viewBox="0 0 16 16"
        ...
        <div>
          <p className="text-[#030303] text-center text-2xl font-bold">
