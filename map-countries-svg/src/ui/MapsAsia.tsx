...
const locations: Location[] = [
  {
    ...
    imageUrlMobile:
      "https://www-krediya-com.sandbox.hs-sites.com/hs-fs/hubfs/Remesa_panama_china_Tabla_POPUP_VERT.png?width=1080&name=Remesa_panama_china_Tabla_POPUP_VERT.png",
  },
];
...
const highlightedCountries = ["China"];

interface InteractiveMapsAsiaProps {
  hideHeader?: boolean;
}

export default function InteractiveMapsAsia({
  hideHeader = false,
}: InteractiveMapsAsiaProps) {
  ...
  const [projectionConfig, setProjectionConfig] = useState({
    center: [104, 30] as [number, number],
    scale: 800,
  });
  ...
  useEffect(() => {
    if (isMobile) {
      // Mobile configuration: zoomed out more to see the whole region
      setProjectionConfig({
        center: [104, 35],
        scale: 900,
      });
    ...
    >
      ...
      {!hideHeader && (
        <div id="header_map-countries-svg">
          <h1 id="header-title_map-countries-svg">Nuestra Presencia en Asia</h1>
                ...
                return geographies.map((geo) => {
                  ...
                  const geographyContent = (
                    <Geography
                      ...
                      geography={geo}
                      fill={
                        isHighlighted ? "url(#countryGradientAsia)" : "#D1D5DB"
                      }
      ...
      {selectedLocation && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div
              id="modal-header_asia_map-countries-svg"
              className="modal-header_map-countries-svg"
            >
              <div
                id="modal-header-content_asia_map-countries-svg"
                className="modal-header-content_map-countries-svg"
              >
                <div
                  id="modal-header-left_asia_map-countries-svg"
                ...
                >
                  ...
                  />
                  <h2
                    id="modal-title_asia_map-countries-svg"
                ...
                >
                  <X
                    id="modal-close-icon_asia_map-countries-svg"
            ...
            {/* Modal Content */}
            <div
              id="modal-body_asia_map-countries-svg"
